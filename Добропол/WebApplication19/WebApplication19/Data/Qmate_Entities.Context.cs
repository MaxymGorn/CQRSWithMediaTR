...
namespace Qmate.Preliminary.Registration.General.Data
{
    using System;
    ...
    public partial class Qmate_Entities : DbContext
    {
        ...
        public virtual ObjectResult<Nullable<int>> AddClient(int? terminalId, string authCode, int? clientId, int? segmentId, string setTime, int? employeeId, int? needApply, string clientPhone, string clientEmail, string commentary, string clientName, string information, string typeInformation, string timeInHold, int? setId, int? notificationType, int? notificationEvt, int? jobId)
        {
            var terminalIdParameter = terminalId.HasValue ?
                new ObjectParameter("TerminalId", terminalId) :
                new ObjectParameter("TerminalId", typeof(int));
